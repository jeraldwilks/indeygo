...
function FundraisingPage() {
  ...
  const handleProductTypeChange = (event) => {
    ...
    if (selectedIndex === -1) {
      ...
      newSelectedProductTypes = selectedProductTypes.slice(1);
    } else if (selectedIndex === selectedProductTypes.length - 1) {
      newSelectedProductTypes = selectedProductTypes.slice(0, -1);
    } else if (selectedIndex > 0) {
      newSelectedProductTypes = [
        ...selectedProductTypes.slice(0, selectedIndex),
        ...selectedProductTypes.slice(selectedIndex + 1),
      ];
    }
                ...
                >
                  {productTypes.map((productType) => (
                    <MenuItem key={productType._id} value={productType._id}>
                      <Checkbox checked={selectedProductTypes.indexOf(productType._id) > -1} />
